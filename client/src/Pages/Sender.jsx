  ...
  const renderStepContent = () => {
    switch (step) {
      case 1:
        return (
          <>
            <h5 className="send_parcel">Sender Details</h5>
            <TextField
              label="Sender Name"
              variant="outlined"
              fullWidth
       ...
       case 2:
        return(
           <>
          <h5 className="send_parcel">Reciver Details</h5>
          <TextField
            label="Reciver Name"
            variant="outlined"
            fullWidth
        ...
        return (
          <>
            ...
            <Card style={{ maxWidth: 600, lineHeight: '10px', fontSize: 'small',boxShadow: '4px 4px 8px rgba(0, 0, 0, 0.1)', backgroundColor:'#fffdfb'  }}>
                ...
                <Button variant="contained" style={{ backgroundColor: '#42820F'}} onClick={submithandleClick}>
              Submit
            </Button>
          </>
        );
