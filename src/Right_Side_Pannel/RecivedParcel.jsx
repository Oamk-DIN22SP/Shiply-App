...
export default function RecivedParcel() {
  return (
    ...
    <div className="details">
        ...
        <p className='heading' style={{border:'1px solid #FFFAF6', padding:'10px', backgroundColor:'#FFFAF6',borderRadius:'10px 10px 0 0'}}>Receive Parcel</p>
    
        {/* Grid with different background colors */}
        <Grid style={{ backgroundColor: '#FCF2FF', padding: '10px', borderRadius: '5px', marginTop: '10px', height: '70vh' }}>
